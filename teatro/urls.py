...
urlpatterns = [
    ...
    path('menuAdmin/listaAreas/areasInfoAdmin/readAreaReportes/<int:idA_>', views.readAreaReportes, name='readAreaReportes'),#Ruta temporal
    ...
    path('menuAdmin/listaAreas/areasInfoAdmin/readElementoReportes/', views.readElementoReportes, name='readElementoReportes'),
